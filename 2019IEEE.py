...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr  2 14:29:20 2019
...
key = ''
r = Robot(left=(9,11), right=(24,23))  # 23,24 11,9 check ports

def forward(): #... add onto the left 
    m1_speed = motors.motor1.setSpeed(240)
    m2_speed = motors.motor2.setSpeed(240) #ml
